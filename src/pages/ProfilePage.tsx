      ...
      {!user ? (
        ...
        <div>
          ...
          <div className="relative w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] rounded-xl overflow-hidden mb-4">
            ...
            <button className="absolute bottom-4 right-4 bg-white/10 backdrop-blur-md text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg hover:bg-white/20 transition-colors flex items-center space-x-2 text-sm sm:text-base">
              <svg
                        ...
                        <div className="text-center py-8 sm:py-12">
                          ...
                          <Link to="/create">
                            <motion.button
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium py-2 px-4 sm:py-2 sm:px-6 rounded-lg shadow-lg text-sm sm:text-base"
                            >
                              Create a Post
                            </motion.button>
                          </Link>
