            ...
            <NavLink to="/create-ai">
              <div className="flex items-center">
                ...
                <span className="relative">
                  Create Post
                  <span className="absolute -top-3 -right-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-[10px] px-1.5 py-0.5 rounded-full">
                    AI
                  </span>
                </span>
              </div>
                      ...
                      >
                        ...
                        <div className="py-2">
                          ...
                          <button
                            ...
                            className="w-full flex items-center px-4 py-2 text-sm text-red-400 hover:bg-white/10 hover:text-red-300 transition-colors"
                          >
                            <svg
        ...
        {menuOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-5">
              ...
              <MobileNavLink to="/create-ai" onClick={() => setMenuOpen(false)}>
                <div className="flex items-center">
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
